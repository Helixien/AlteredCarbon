...
namespace AlteredCarbon
{
    ...
    public class Building_DecryptionBench : Building_WorkTable
    {
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            {
                var rewriteStack = new Command_ActionOnStack(this, ForFilledStack(includeArchoStack: AlteredCarbonMod.settings.enableArchostackRewriting), InstallRewriteBill)
                {
                    ...
                    action = delegate ()
                    {
                        Find.Targeter.BeginTargeting(ForFilledStack(includeArchoStack: AlteredCarbonMod.settings.enableArchostackRewriting), delegate (LocalTargetInfo x)
                        {
